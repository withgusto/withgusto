...
function updateNav( index ){
  ...
  $(".top-bar-section li a" + "[data-section='" + index + "']").css({'border-bottom':'2px solid #222','color':'#222'});

  // add and remove nav active here.

  if(index === 1){ return; }

  $(".top-bar-right li a " + "[data-section='" + index + "']").css({'border-bottom':'2px solid #222',  'color':'#222'});
